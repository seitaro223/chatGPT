%% BT09A_apply_Fform_linear_to_macro_copies_v2.m
% BT09-A v2：コピー版マクロブックへ Fform_linear を投入する
%
% v2修正点：
...
outSummaryXlsx = "BT09A_v2_Fform_linear_macro_replacement_summary_" + timestamp + ".xlsx";
outMd = "run_report_BT09A_v2_Fform_linear_macro_replacement_" + timestamp + ".md";
...
md(end+1) = "v2では ws.Range(\"BG2\").Value のようなA1セルアドレス指定でF_formを書き込む。";
md(end+1) = "```";
md(end+1) = "";
md(end+1) = "## 2. 入力";
md(end+1) = "";
