%% STLD00_single_tube_Tsub_between_within_v2.m
...
%
% 出力:
%   STLD00_single_tube_Tsub_between_within_v2_yyyymmdd_HHMMSS.xlsx
%   run_report_STLD00_single_tube_Tsub_between_within_v2_yyyymmdd_HHMMSS.md
%
% 判定:
...
outXlsx = "STLD00_single_tube_Tsub_between_within_v2_" + timestamp + ".xlsx";
outMd   = "run_report_STLD00_single_tube_Tsub_between_within_v2_" + timestamp + ".md";

fig1 = "fig_STLD00_v2_01_PM_F1_vs_Tsub_by_LDgroup_" + timestamp + ".png";
fig2 = "fig_STLD00_v2_02_group_mean_PM_Tsub_LD_" + timestamp + ".png";
fig3 = "fig_STLD00_v2_03_within_PM_vs_within_Tsub_" + timestamp + ".png";
fig4 = "fig_STLD00_v2_04_model_R2_decomposition_" + timestamp + ".png";
...
if best.primaryRows == 0
    writetable(scan, "STLD00_v2_sheet_scan_failed_" + timestamp + ".xlsx", "Sheet", "sheet_scan");
...
function makeFigures(P, res, fig1, fig2, fig3, fig4)
    ...
    xlabel("Tsub [K]");
    ylabel("PM_F1 [-]");
    title("ST-LD-00 v2: PM_F1 vs Tsub by L/D group");
    ...
    ylabel("R^2");
    title("ST-LD-00 v2 model comparison");
    grid on; box on;
    xtickangle(30);
    saveas(f, fig4);
    close(f);
...
function writeReport(outMd, inFile, chosenSheet, meta, scan, primary, reference, perTableAll, fig1, fig2, fig3, fig4)
    ...
    fprintf(fid, "# ST-LD-00 v2 single-tube Tsub between/within decomposition\n\n");
