function TM00c_legacy_bridge_audit_v1(rootDir, tm00bXlsx, legacyXlsx, legacySheet)
% TM00c_legacy_bridge_audit_v1
%
% Purpose:
...
assert(~isempty(allD), ['No legacy workbook found. Provide legacyXlsx explicitly, e.g.\n' ...
    '  TM00c_legacy_bridge_audit_v1(pwd, "", "H52Q_current_single_tube_input_v1_....xlsx")']);
...
T = ensureVar(T, 'ExptNo', {'ExptNo','EXPT NO','No_TableNo','NoTableNo','No','No_Table','No_Table_No'});
...
metrics.checkName = [ ...
    ...
    "overlap_all_expected_if_legacy_anchor"; ...
    "new_only_all_expected_if_legacy_anchor"; ...
    "legacy_only_all_expected_if_legacy_anchor"; ...
    "T10_overlap_expected_if_legacy_anchor"; ...
    "T10_new_only_expected_if_legacy_anchor"; ...
    "T10_legacy_only_expected_if_legacy_anchor" ...
    ];
metrics.expected = [280;176;30;190;30;30;30;86;30;30;137;143;39;47;143;39];
...
metrics.status(metrics.actual ~= metrics.expected) = "CHECK";
E = metrics;
end
