...
- macro workbook: `celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm`
...
| --- | --- | --- | --- | --- | --- | --- |
| celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm | tm | 1 | 59 | BG1 | F_form | Fform_like_header_or_cell |

## 8. No header candidates

| file | sheet | row | col | excel_cell | value | hit_type |
| --- | --- | --- | --- | --- | --- | --- |
| celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm | tm | 1 | 13 | M1 | No | No_like_header_or_cell |
...
| file | sheet | row | col | excel_cell | value | hit_type |
| --- | --- | --- | --- | --- | --- | --- |
| celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm | tm | 1 | 54 | BB1 | q_P | keyword_hit |
| celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm | tm | 1 | 57 | BE1 | q_M | keyword_hit |
| celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm | tm | 1 | 58 | BF1 | PM_ratio | keyword_hit |
| celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm | tm | 1 | 59 | BG1 | F_form | keyword_hit |
| celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm | tm | 1 | 65 | BM1 | q_P_MW | keyword_hit |
| celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm | Log | 1 | 4 | D1 | q_P | keyword_hit |
...
| 4 | Do not edit original | Original macro workbook remains unchanged: celataモデル_簡易計算_単管_櫻井検算r125_バンドルF1なし.xlsm |
